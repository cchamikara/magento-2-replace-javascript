...
define(['jquery', 'underscore', 'jquery/ui'], function ($, _) {
    ...
    $.widget('custom.SwatchRenderer', {
         ...
         */
        _create: function () {
            console.log('swatches js overrided');
        ...
        _RenderFakeTabs: function (config) {
            console.log('fake tab fun loaded');
            var tabs = '';
            ...
            $.each(config.options, function () {
                ...
                if (config.code == 'muaw_gender') {
                    ...
                    tabs += '<div role="tabpanel" class="tab-pane fade ' + activeClass + '" id="' + value + '">' + value + '</div>';
                }
            });
            return tabs;
        },
